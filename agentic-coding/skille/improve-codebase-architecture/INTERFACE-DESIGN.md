...
Spawnuj 2-3 sub-agentów paralelnie używając narzędzia Agent. Każdy musi wyprodukować **radykalnie inny** interfejs dla pogłębionego modułu.
...
- Agent 4 (warunkowy — tylko gdy zależność jest kategorii 3-4 wg [DEEPENING.md](DEEPENING.md)): "Zaprojektuj wokół ports & adapters dla zależności cross-seam."
