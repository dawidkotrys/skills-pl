...
**GREEN = obiektywny warunek "done"** dla danego zachowania — test pinujący zachowanie jest dowodem, który redukuje potrzebę subiektywnego review tego zachowania.
...
**Kod minimalny ≠ hardcode pod wartość testu.** Minimalny znaczy: najprostsza GENERALNA logika przechodząca test. AI pod presją potrafi hardcode'ować wartości oczekiwane przez test — vertical slicing to utrudnia, ale sprawdzaj po każdym GREEN, czy implementacja generalizuje.
