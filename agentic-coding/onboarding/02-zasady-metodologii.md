...
Krótka lista zasad pracy z LLM-ami w kodzie. **10 punktów** — wszystko czego potrzebujesz na start. Nie musisz pamiętać ich wszystkich — wystarczy wiedzieć **że istnieją** i o czym są, żeby wracać tu po szczegóły kiedy trzeba.
...
**Na co dzień** — wracaj tu kiedy potrzebujesz przypomnienia konkretnej zasady (np. "co metodologia mówi o vertical slicing" → zasada #5).
